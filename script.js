...
if (imageSlider && imageWrapper) {
    ...
    const stepImage = () => {
        ...
        requestID = requestAnimationFrame(stepImage);
    };
    ...
    imageSlider.addEventListener('touchstart', (e) => {
        isDown = true;
        startX = e.touches[0].pageX - imageSlider.offsetLeft;
        scrollLeft = imageSlider.scrollLeft;
    });
    ...
    imageSlider.addEventListener('touchmove', (e) => {
        if (!isDown) return;
        const x = e.touches[0].pageX - imageSlider.offsetLeft;
        const walk = (x - startX) * 2;
        imageSlider.scrollLeft = scrollLeft - walk;
    });
}
...
if (videoSlider && videoWrapper) {
    ...
    const stepVideo = () => {
        ...
        requestID = requestAnimationFrame(stepVideo);
    };
